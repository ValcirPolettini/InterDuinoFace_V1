...
// @formatter:off
  ...
  Pinset(
      ...
      int8_t pin9 = UNDEFINED,
      int8_t pin10 = UNDEFINED,
      int8_t pin11 = UNDEFINED,
      int8_t pin12 = UNDEFINED,
      int8_t pin13 = UNDEFINED,
      int8_t pin14 = UNDEFINED,
      int8_t pin15 = UNDEFINED
  ){
    pins[0] = pin0;
    pins[1] = pin1;
    pins[2] = pin2;
